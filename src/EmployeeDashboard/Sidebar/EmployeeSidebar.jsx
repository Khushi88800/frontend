...
import DocumentManagement from "../Documents/EmpDoc";
import PayrollSection from "../Bank/Payroll";
import EmployeeDetails from "../Details/EmployementDetails";
import ProfilePage from "../Employment/Employment";
import EmployeeDocuments from "../../components/EmployeeDocuments"
import HolidayDashboard from "../Timeoff.jsx/Holiday";
import EmployeeReviews from "../Review/Review";
import EmployeeSetting from "../Setting/EmployeeSetting";
import { CiLogout } from "react-icons/ci";
import { logout } from "../../redux/userSlice";
import LeaveApplicationForm from "../ApplyLeave/EmpLeave";
import EmpSetting from "../profile/EmpProfile";
    ...
    <div className="w-full  flex flex-col lg:flex-row min-h-screen bg-gray-50  ">
      ...
      >
        ...
        <div className="bg-white p-6 rounded-md ">
          ...
          <h2 className="text-sm text-black font-semibold text-center capitalize pt-8">hii,{userData.fullName}</h2>
        ...
        <nav className="p-8 grid grid-cols-2 bg-white gap-4 fixed  left-0 z-50 top-auto h-[80px] ">
          <NavLink
            ...
            className={({ isActive }) =>
              `py-3 text-center rounded-lg  transition-colors flex flex-col items-center ${isActive
        ...
        {isLoggedIn && (
          <div className="fixed bottom-4 left-0 right-0  bg-white border-t border-gray-200 p-4 md:hidden">
      ...
      <div className="flex-1  px-4 pb-4   min-h-screen   ">
        ...
        <main className="mt-6 max-w-[1920px] mx-auto">
          ...
          <Routes>
            ...
            <Route path="/employee-doc" element={<DocumentManagement />} />
            <Route path="/timeoff" element={<HolidayDashboard />} />
            <Route path="/reviews" element={<EmployeeReviews />} />
            <Route path="/settings" element={<EmployeeSetting />} />
            <Route path="/me" element={<EmpSetting />} />
