...
function Dashboard({ onClose }) {
    ...
    console.log("emp data", employeesData);
    ...
    return (
        <>
            {/* Main Content */}
            <div className="min-h-screen flex-1 md:ml-20 pt-5 flex flex-col gap-10 select-none">
                ...
                <div className="flex items-center justify-between md:space-x-6 md:ml-64">
                ...
                <div className="overflow-x-auto w-full md:mt-10">
                    <h1 className='text-xl text-center font-semibold tracking-wide text-cyan-800'> Employee Data</h1>
                    <Link to="/add">
                        <button onClick={onClose} className='border border-cyan-600 hover:border-cyan-500 transition-all ease-in-out duration-300 rounded-sm px-2.5 py-1.5 text-center font-semibold text-cyan-600'>
                            Create Employee
                        </button>
                    </Link>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:mt-10">
                    <div className="flex flex-col space-y-5">
                        ...
                        <div className="bg-white shadow-lg rounded-lg p-6">
                            <h2 className="text-xl font-semibold text-gray-700">Active Employees</h2>
                    ...
                    <div className="bg-white shadow-lg rounded-lg p-6 col-span-1 md:col-span-1">
                        <h2 className="text-xl font-semibold text-gray-700 mb-4 text-center">Employee Growth </h2>
                        {/* Graph placeholder */}
