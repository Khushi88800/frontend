...
function Dashboard({ onClose }) {
    ...
    return (
        <>
            {/* Main Content */}
            <div className="min-h-screen flex-1 md:ml-24 flex flex-col gap-10 select-none">
                ...
                <div className="flex items-center justify-between md:space-x-6 md:mt-20 md:ml-64">
                    ...
                    <Link to="/profile/me" className="flex items-center space-x-2">
                        <img
                            src={userData?.avatar?.secure_url}
                            className="w-11 h-11 cursor-pointer md:block hidden"
                            alt="User Avatar"
                        />
